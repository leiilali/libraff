...
function MyAccount() {
    ...
    return (
        <div className='relative'>
            <LuCircleUser onClick={() => setIsOpen(!isOpen)} className='xl:hidden text-[28px]' />
            <div
                onClick={() => setIsOpen(!isOpen)}
                className=' items-center gap-2 bg-[#F5F6FD] py-2.5 px-5 rounded-full hidden xl:flex'>
            ...
            <div className={`w-[340px] border-[0.5px] border-[#EBEBEB] rounded-b-xl rounded-t-none lg:rounded-t-xl 
                ...
                <div className='px-5 py-4  bg-[#F5F5F7] '>
                    ...
                    <div className='nunito-font border border-[#bbb] flex justify-between rounded-lg overflow-hidden hover:shadow-[0_0_0_2px_rgba(239,51,64,0.1)] my-2'>
                        ...
                        transition duration-100 ease-in-out placeholder:text-[14px] placeholder:nunito-font'  placeholder='Sifariş nömrəsi/E-poçt'
                        />
                        <button className='flex justify-center items-center px-2 border-l border-l-[#bbb]'><RxTriangleRight className='text-[#767676] text-[25px]' /></button>
