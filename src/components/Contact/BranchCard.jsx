    ...
    return (
        <div className='flex flex-wrap gap-6 justify-between'>
            {Array(7).fill(null).map((_, index) => (
                <div className="rounded-[4px] shadow-[0_4px_20px_rgba(0,0,0,0.15)] p-5 flex-1 basis-full sm:basis-1/2 lg:basis-[32%]">
                    <div>
                        <div className='py-5'>
                            <h3 className='text-[18px] !font-semibold nunito-font'>Gənclik Mall filialı</h3>
                            <p className='nunito-font text-[#5b5b5b] text-[16px] font-light py-[6px]'>Bakı şəhəri, Nərimanov rayonu, Fətəli Xan Xoyski küçəsi 38, "Gənclik Mall" Ticarət Mərkəzi.</p>
                        </div>
                        <div className='py-5'>
                            <h3 className='text-[18px] !font-semibold nunito-font'>Iş saatları:</h3>
                            <p className='nunito-font text-[#5b5b5b] text-[15px] font-light py-[6px]'>Hər gün 10:00 - 22:00</p>
                        </div>
