        ...
        <div className='container'>
            ...
            <table className="w-full text-left">
                ...
                <tbody>
                    <tr className="border-b [border-color:#E1E1E1] ">
                        <td className="py-4">
                            <div className="flex items-center gap-4 max-w-full overflow-hidden">
                                ...
                                <div className="flex-1">
                                    <div className="font-light nunito-font text-[#ef3340] flex items-center gap-2">
                                        Anna Karenina
                                        <button className="text-[#ef3340] text-lg"><RiCloseCircleFill /></button>
                                    </div>
                                    <div className="text-[12px] font-light nunito-font text-[#767676] pt-1">Kod: 9789952563306</div>
                                </div>
                            </div>
                        </td>
                        <td className="text-right py-4">
                            <div className="flex justify-end items-center gap-2">
                                <span className="text-[#ef3340] line-through text-[14px] font-light">15.70 ₼</span>
                                <span className="text-[#0d1219] text-[14px] font-light">10.40 ₼</span>
                            </div>
                        </td>
                        ...
                        <td className="text-right py-4 font-medium">10.40 ₼</td>
                    </tr>
                </tbody>
            </table>
            ...
            <div className='bg-[#F5F5F7] p-5 rounded-2xl mt-10 flex justify-between items-center'>
                <div className='flex items-center gap-3'>
                    ...
                    <button className='border-2 border-[#EF3441] py-1.5 px-4 rounded-full font-semibold text-[#0f172a] nunito-font'>
                        Səbəti təmizlə
                    </button>
                </div>
