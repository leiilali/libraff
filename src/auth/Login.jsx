        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl py-3 w-full max-w-sm shadow-xl relative">
                ...
                <div className="p-6">
                    ...
                    <p className='text-center text-[#64748B] nunito-font font-light text-[14px] mt-4'>
                        Hesabınız yoxdur?{" "}
                        <Link to="/qeydiyyat" className='text-[#EE2E39] font-semibold'>Qeydiyyatdan keçin</Link>
                    </p>
                </div>
            </div>
        </div>
